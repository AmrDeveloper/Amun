...
template<class T>
void material_print(T text, const int text_color, const int background_color) {
#if defined(_WIN32)
...
template<class T>
void material_println(T text, const int text_color, const int background_color) {
