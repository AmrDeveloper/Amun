...
static std::unordered_map<TokenKind, const char*> token_kind_literal = {
    ...
    {TokenKind::Bang, "Bang !"},
    {TokenKind::BangEqual, "Bang Equal !="},
    
    {TokenKind::Greater, "Greater >"},
    {TokenKind::GreaterEqual, "Greater Equal >="},
    {TokenKind::Smaller, "Smaller <"},
    {TokenKind::SmallerEqual, "Smaller Equal <="},
    
    {TokenKind::PlusEqual, "Plus Equal +="},
    {TokenKind::MinusEqual, "Minus Equal -="},
    {TokenKind::StarEqual, "Star Equal *="},
    {TokenKind::SlashEqual, "Slash Equal /="},
    {TokenKind::PercentEqual, "Percent Equal %="},
