...
int main([[maybe_unused]] int argc, [[maybe_unused]] char **argv) {
    ...
    auto parsing_duration =
        duration_cast<std::chrono::milliseconds>(parsing_end_time - parsing_start_time);
    ...
    auto checker_duration =
        duration_cast<std::chrono::milliseconds>(checker_end_time - checker_start_time);
    ...
    auto compiling_duration =
        duration_cast<std::chrono::milliseconds>(compiling_end_time - compiling_start_time);
